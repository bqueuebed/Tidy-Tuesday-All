...
In the analysis, it might also be wise to control for the length of lines in the code given---again, accounting for different coders' styles and formatting preferences. 


aiwjsdfpojaspodjfapodsijf